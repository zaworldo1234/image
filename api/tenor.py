...
config = {
    ...
    "image": "http://imagestechhive.com/images/articie/2014/04/windows-xp-bliss-desktop-image-100259888-orig.jpg", # You can also have a custom image by using a URL argument
